<?php
	...
	echo $_s->build_css(
		...
		array_merge(
			...
			$script->get_parent()->get_setting('navbar_item_text_deco_link')->get_css_data('text-decoration')
		)
	);
	...
	echo $_s->build_css(
		...
		array_merge(
			...
			$script->get_parent()->get_setting('navbar_item_text_deco_link_hover')->get_css_data('text-decoration')
		)
	);